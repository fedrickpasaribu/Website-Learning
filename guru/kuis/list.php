                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <a href="javascript:;" onclick="load_input('<?= base_url('guru/kuis/edit.php?id=' . $row['id_kuis']) ?>')" class="btn btn-warning">
                                    <span class="symbol-btn-group me-2">
                                        <i class="fa fa-pencil"></i>
                                    </span>
                                    Ubah
                                </a>
                                <a href="javascript:;" onclick="hapus('<?= $row['id_kuis'] ?>', '<?= base_url('guru/kuis/function.php') ?>')" class="btn btn-danger">
                                    <span class="symbol-btn-group me-2">
